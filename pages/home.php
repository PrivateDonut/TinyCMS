...
require_once BASE_DIR . '/engine/functions/gen_config.php';
...
// Create Account instance if username is set
...
// Get news and server information
...
<div class="howto-section">
    ...
    <p><?php echo htmlspecialchars($server->get_realm_name()); ?></p>
</div>
...
<div class="server-status-inner mx-auto" style="padding: 20px;">
    <div class="card-title custom-card-title text-center" style="margin-bottom: 20px; font-size:22px;">
        ...
        <span><?php echo htmlspecialchars($server->get_realm_name()); ?></span>
    </div>
